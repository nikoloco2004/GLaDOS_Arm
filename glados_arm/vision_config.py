...
LOWER_BOUND_WRIST_ONLY_MAX_DEG = 95.0
LOWER_BOUND_WRIST_ONLY_GAIN_DEG_PER_NORM = 180.0
LOWER_BOUND_PIN_MARGIN_DEG = 3
LOWER_BOUND_WRIST_ONLY_DOWN_ZSTEP_EPS_MM = 0.02
LOWER_BOUND_WRIST_ONLY_DOWN_YFORZ_EPS_NORM = 0.03
LOWER_BOUND_WRIST_ONLY_DEADBAND_NORM = 0.02
LOWER_BOUND_WRIST_ONLY_NEAR_NORM = 0.10
LOWER_BOUND_WRIST_ONLY_NEAR_SCALE = 0.80
LOWER_BOUND_WRIST_ONLY_MAX_STEP_DEG = 5
