...
echo "Next steps:"
echo "  1) ./scripts/setup_ollama_pi.sh          # Ollama + pull llama3.2:1b"
echo "  2) ./scripts/pi_list_audio_devices.sh    # print PortAudio indices"
echo "  3) Optional: export GLADOS_SD_INPUT_DEVICE=N GLADOS_SD_OUTPUT_DEVICE=M"
