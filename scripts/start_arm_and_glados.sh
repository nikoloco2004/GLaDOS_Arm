...
PI_AUDIO_OUTPUT_SR="${PI_AUDIO_OUTPUT_SR:-48000}"
GLADOS_SD_OUTPUT_DEVICE="${GLADOS_SD_OUTPUT_DEVICE:-default}"
PI_PLAYBACK_PAPLAY="${PI_PLAYBACK_PAPLAY:-1}"
XDG_RUNTIME_DIR="${XDG_RUNTIME_DIR:-/run/user/$(id -u)}"
BRIDGE_CMD_DEFAULT="PI_RUNTIME_HOST=${PI_RUNTIME_HOST} PI_RUNTIME_PORT=${PI_RUNTIME_PORT} PI_AUDIO_OUTPUT_SR=${PI_AUDIO_OUTPUT_SR} GLADOS_SD_OUTPUT_DEVICE=${GLADOS_SD_OUTPUT_DEVICE} PI_PLAYBACK_PAPLAY=${PI_PLAYBACK_PAPLAY} XDG_RUNTIME_DIR=${XDG_RUNTIME_DIR} ${BRIDGE_PY} -m pi_runtime"
